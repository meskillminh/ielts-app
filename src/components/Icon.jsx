// Inline SVG icon set (Lucide-style). Replaces cross-device emoji ("tofu") icons.
const PATHS = {
  ...
  bookmarked: <><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" /><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" /><path d="M10 2v7l2-1.5L14 9V2" /></>,
